    ...
    methods: {
        getOrdersInfo: function() {
            return [
                ...
                {code: 12, name: "休整", type: 3, bonus: 0},
                {code: 13, name: "休整", type: 3, bonus: 0},
                {code: 14, name: "休整", type: 3, bonus: 0},
                {code: 15, name: "休整", type: 3, bonus: 0},
                {code: 16, name: "休整", type: 3, bonus: 0},
                {code: 17, name: "休整", type: 3, bonus: 0},
            ];
        },
