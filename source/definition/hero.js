    ...
    methods: {
        getHerosInfo: function() {
            return [
                [],
                [
                    {code: 0, name: "齐威王", state: 1, strength: 2, kill: 0, safe: 0, skill: "战斗胜利后,将一个本地参战军团升级为" + this.getArmyInfo()[1].name},
                ...
                [
                    {code: 6, name: "楚怀王", state: 2, strength: 2, kill: 0, safe: 0, skill: "战斗胜利后,将一个本地参战军团升级为" + this.getArmyInfo()[2].name},
                ...
                [
                    {code: 12, name: "燕昭王", state: 3, strength: 2, kill: 0, safe: 0, skill: "战斗胜利后,将一个本地参战军团升级为" + this.getArmyInfo()[3].name},
                ...
                [
                    {code: 18, name: "赵武灵王", state: 4, strength: 2, kill: 0, safe: 0, skill: "战斗胜利后,将一个本地参战军团升级为" + this.getArmyInfo()[4].name},
                ...
                [
                    {code: 30, name: "魏文侯", state: 6, strength: 2, kill: 0, safe: 0, skill: "战斗胜利后,将一个本地参战军团升级为" + this.getArmyInfo()[6].name},
