    ...
    methods: {
        getCitiesInfo: function() {
            return [
                ...
                {code: 3, name: "太原", position: [440, 170], resource: [1], type: 1},
                {code: 4, name: "邯郸", position: [615, 210], resource: [0, 1], type: 0},
                {code: 5, name: "上谷", position: [705, 50], resource: [1], type: 2},
                ...
                {code: 19, name: "大梁", position: [650, 365], resource: [0,1], type: 0},
                {code: 20, name: "饶安", position: [720, 170], resource: [1], type: 2},
                {code: 21, name: "临淄", position: [790, 220], resource: [0,1], type: 0},
                {code: 22, name: "定陶", position: [705, 300], resource: [1], type: 2},
                ...
                {code: 27, name: "安邑", position: [445, 375], resource: [1], type: 2},
